...
3. Run:
       python "sentiment_ml_dict testing.py"
"""
...
POSITIVE_DICT_FILE = os.path.join(SCRIPT_DIR, "../dictionary/ML_positive_bigram.txt")
NEGATIVE_DICT_FILE = os.path.join(SCRIPT_DIR, "../dictionary/ML_negative_bigram.txt")
OUTPUT_DIR         = os.path.join(SCRIPT_DIR, "output-bigrams")
os.makedirs(OUTPUT_DIR, exist_ok=True)

OUT_PATH      = os.path.join(OUTPUT_DIR, "sentiment_summary_top25.csv")
FULL_OUT_PATH = os.path.join(OUTPUT_DIR, "sentiment_full_top25.json")
...
print("Loading ML bigram dictionaries...")
...
if __name__ == "__main__":
    ...
    for label, tickers, out_csv, out_json in [
        ...
        ("Bottom 25", BOTTOM25_TICKERS, OUT_PATH.replace("sentiment_summary", "sentiment_summary_bottom25"),
                                        FULL_OUT_PATH.replace("sentiment_full", "sentiment_full_bottom25")),
    ]:
